...
namespace Sebas_lavadero.Controllers
{
    public class ServicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Price,Id,CreateDate,ModifiedDate")] Service service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Name,Price,Id,CreateDate,ModifiedDate")] Service service)
        {
            if (id != service.Id)
            {
                return NotFound();
